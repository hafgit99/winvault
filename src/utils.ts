...
export const TRANSLATIONS = {
  tr: {
    ...
    clipboardTimeout: "Pano Temizleme Süresi",
    clipboardTimeoutDesc: "Kopyalanan şifre panonuzdan kaç saniye sonra temizlensin?",
    time10sec: "10 Saniye",
    time30sec: "30 Saniye",
    time1min: "1 Dakika",
    time2min: "2 Dakika",
  ...
  en: {
    ...
    clipboardTimeoutDesc: "How long should copied passwords stay in clipboard?",
